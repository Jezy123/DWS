 ...
 */
final class Version20221114120832 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE image (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, file VARCHAR(255) NOT NULL, num_likes INT NOT NULL, num_views INT NOT NULL, num_dowloads INT NOT NULL, INDEX IDX_C53D045F12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
